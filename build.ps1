...
#cp .\src\build.json .\src\Cortside.RestFS.WebApi\build.json -force
...
Invoke-Exe -cmd dotnet -args $args
#$args = "publish $PSScriptRoot\src\Cortside.RestFS.WebApi\Cortside.RestFS.WebApi.csproj --no-restore /p:Version=$BuildNumber"
#Invoke-Exe -cmd dotnet -args $args
