...
dotnet new cortside-api --name Cortside.RestFS --company Cortside --product RestFS
```
...
src\Cortside.RestFS.WebApi\build.json
...
- In Cortside.RestFS.Data, make changes to the database models to match the desired schema.
...
- delete your local `RestFS` database
